...
Generated by `scripts/eval_run.py` against the deployed API. 2 questions, 0.0038 USD, median latency 1790 ms.
...
|---|---|---|---|---|---|---|---|---|
| LD1 | What risks or limitations of the watermarking approach doe | answered | **FAIL** | yes | 0.713 | 0.58 | insufficient_context | 0/5 |
| LD2 | ¿Qué riesgos o limitaciones del enfoque de marcas de agua  | answered | **FAIL** | yes | 0.560 | 0.4 | insufficient_context | 0/5 |
